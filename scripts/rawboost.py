"""RawBoost, MIT (scripts/RawBoost.LICENSE).
Upstream: TakHemlata/RawBoost-antispoofing@4f161a8b4d0d9f4a8431509ddd86c645869ef6c4.
Adaptacion: randRange devuelve un escalar compatible con NumPy 2.
"""
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
def randRange(x1, x2, integer):
    y = np.random.uniform(low=x1, high=x2, size=None)
    if integer:
        y = int(y)
    return y
